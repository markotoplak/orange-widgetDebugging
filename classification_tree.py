...
class GUIApplication(OWBaseWidget):
    def __init__(self,parent=None):
        ...
        OWBaseWidget.__init__(self, title = 'classification_tree', signalManager = self.signalManager)
        self.widgets = {}
        self.loadSettings()
        ...
        self.signalManager.addLink( self.widgets['Classification Tree'], self.widgets['Classification Tree Graph'], 'Classification Tree', 'Classification Tree', 1)
    ...
    def loadSettings(self):
        try:
            file = open("classification_tree.sav", "r")
    ...
    def closeEvent(self, ev):
        ...
        for (name, widget) in self.widgets.items():
            ...
            widget.close()
        file = open("classification_tree.sav", "w")
