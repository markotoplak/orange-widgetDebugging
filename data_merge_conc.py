...
class GUIApplication(OWBaseWidget):
    def __init__(self,parent=None):
        ...
        OWBaseWidget.__init__(self, title = 'data_merge_conc', signalManager = self.signalManager)
        self.widgets = {}
        self.loadSettings()
        ...
        self.createWidget('OWFile', 'icons/File.png', 'File (2)', 1, self.signalManager)
        ...
        self.createWidget('OWDataDomain', 'icons/SelectAttributes.png', 'Select Attributes (2)', 1, self.signalManager)
        self.createWidget('OWMergeData', 'icons/MergeData.png', 'Merge Data (2)', 1, self.signalManager)
        ...
        self.createWidget('OWConcatenate', 'icons/Concatenate.png', 'Concatenate (2)', 1, self.signalManager)
        ...
        self.signalManager.addLink( self.widgets['File'], self.widgets['Concatenate'], 'Examples', 'Primary Table', 1)
        self.signalManager.addLink( self.widgets['File'], self.widgets['Merge Data'], 'Examples', 'Examples A', 1)
        self.signalManager.addLink( self.widgets['File (2)'], self.widgets['Concatenate'], 'Examples', 'Additional Tables', 1)
        self.signalManager.addLink( self.widgets['File (2)'], self.widgets['Merge Data'], 'Examples', 'Examples B', 1)
        self.signalManager.addLink( self.widgets['File'], self.widgets['Select Attributes'], 'Examples', 'Examples', 1)
        self.signalManager.addLink( self.widgets['File'], self.widgets['Select Attributes (2)'], 'Examples', 'Examples', 1)
        self.signalManager.addLink( self.widgets['Select Attributes'], self.widgets['Merge Data (2)'], 'Examples', 'Examples A', 1)
        self.signalManager.addLink( self.widgets['Select Attributes (2)'], self.widgets['Merge Data (2)'], 'Examples', 'Examples B', 1)
        self.signalManager.addLink( self.widgets['File'], self.widgets['Data Sampler'], 'Examples', 'Data', 1)
        self.signalManager.addLink( self.widgets['File (2)'], self.widgets['Data Sampler (2)'], 'Examples', 'Data', 1)
        self.signalManager.addLink( self.widgets['Data Sampler (2)'], self.widgets['Concatenate (2)'], 'Sample', 'Primary Table', 1)
        self.signalManager.addLink( self.widgets['Data Sampler'], self.widgets['Concatenate (2)'], 'Sample', 'Additional Tables', 1)
    ...
    def loadSettings(self):
        try:
            file = open("data_merge_conc.sav", "r")
    ...
    def closeEvent(self, ev):
        ...
        for (name, widget) in self.widgets.items():
            ...
            widget.close()
        file = open("data_merge_conc.sav", "w")
