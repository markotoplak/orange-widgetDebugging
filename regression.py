...
class GUIApplication(OWBaseWidget):
    def __init__(self,parent=None):
        ...
        OWBaseWidget.__init__(self, title = 'regression', signalManager = self.signalManager)
        self.widgets = {}
        self.loadSettings()
        ...
        self.signalManager.addLink( self.widgets['File'], self.widgets['Regression Tree'], 'Examples', 'Example Table', 1)
        ...
        self.signalManager.addLink( self.widgets['File'], self.widgets['Pade'], 'Examples', 'Examples', 1)
