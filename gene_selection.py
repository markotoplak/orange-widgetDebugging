...
class GUIApplication(OWBaseWidget):
    def __init__(self,parent=None):
        ...
        OWBaseWidget.__init__(self, title = 'gene_selection', signalManager = self.signalManager)
        self.widgets = {}
        self.loadSettings()
        ...
        self.signalManager.addLink( self.widgets['Data Sampler'], self.widgets['Gene Selection'], 'Sample', 'Examples', 1)
        self.signalManager.addLink( self.widgets['Gene Selection'], self.widgets['Data Table'], 'Example table with selected genes', 'Examples', 1)
    ...
    def loadSettings(self):
        try:
            file = open("gene_selection.sav", "r")
    ...
    def closeEvent(self, ev):
        ...
        for (name, widget) in self.widgets.items():
            ...
            widget.close()
        file = open("gene_selection.sav", "w")
