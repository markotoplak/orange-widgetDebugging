...
class GUIApplication(OWBaseWidget):
    def __init__(self,parent=None):
        ...
        OWBaseWidget.__init__(self, title = 'Evaluate2', signalManager = self.signalManager)
        self.widgets = {}
        self.loadSettings()
        ...
        self.createWidget('OWCalibrationPlot', 'CalibrationPlot.png', 'Calibration Plot', 1, self.signalManager)
        self.createWidget('OWConfusionMatrix', 'ConfusionMatrix.png', 'Confusion Matrix', 1, self.signalManager)
        ...
        self.signalManager.addLink( self.widgets['Test Learners'], self.widgets['Calibration Plot'], 'Evaluation Results', 'Evaluation Results', 1)
