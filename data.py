...
class GUIApplication(OWBaseWidget):
    def __init__(self,parent=None):
        ...
        self.createWidget('OWRank', 'icons/Rank.png', 'Rank', 1, self.signalManager)
        ...
        self.createWidget('OWPurgeDomain', 'icons/PurgeDomain.png', 'Purge Domain', 1, self.signalManager)
        ...
        self.signalManager.addLink( self.widgets['Data Sampler'], self.widgets['Rank'], 'Sample', 'Examples', 1)
        self.signalManager.addLink( self.widgets['Data Sampler'], self.widgets['Discretize'], 'Sample', 'Examples', 1)
        self.signalManager.addLink( self.widgets['Data Sampler'], self.widgets['Continuize'], 'Sample', 'Examples', 1)
        self.signalManager.addLink( self.widgets['Data Sampler'], self.widgets['Purge Domain'], 'Sample', 'Examples', 1)
        self.signalManager.addLink( self.widgets['Data Sampler'], self.widgets['Select Data'], 'Sample', 'Examples', 1)
        self.signalManager.addLink( self.widgets['Data Sampler'], self.widgets['Impute'], 'Sample', 'Examples', 1)
        self.signalManager.addLink( self.widgets['Data Sampler'], self.widgets['Data Table'], 'Sample', 'Examples', 1)
