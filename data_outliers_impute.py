...
class GUIApplication(OWBaseWidget):
    def __init__(self,parent=None):
        ...
        OWBaseWidget.__init__(self, title = 'data_outliers_impute', signalManager = self.signalManager)
        self.widgets = {}
        self.loadSettings()
        ...
        self.signalManager.addLink( self.widgets['File'], self.widgets['Impute'], 'Examples', 'Examples', 1)
        self.signalManager.addLink( self.widgets['File'], self.widgets['Outliers'], 'Examples', 'Examples', 1)
        self.signalManager.addLink( self.widgets['Outliers'], self.widgets['Data Table'], 'Outliers', 'Examples', 1)
        self.signalManager.addLink( self.widgets['Outliers'], self.widgets['Data Table'], 'Inliers', 'Examples', 1)
        self.signalManager.addLink( self.widgets['Outliers'], self.widgets['Data Table'], 'Examples with Z-scores', 'Examples', 1)
        self.signalManager.addLink( self.widgets['Impute'], self.widgets['Data Table'], 'Examples', 'Examples', 1)
    ...
    def loadSettings(self):
        try:
            file = open("data_outliers_impute.sav", "r")
    ...
    def closeEvent(self, ev):
        ...
        for (name, widget) in self.widgets.items():
            ...
            widget.close()
        file = open("data_outliers_impute.sav", "w")
