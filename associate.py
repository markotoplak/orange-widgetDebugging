...
class GUIApplication(OWBaseWidget):
    def __init__(self,parent=None):
        ...
        self.createWidget('OWInteractionGraph', 'icons/InteractionGraph.png', 'Interaction Graph', 1, self.signalManager)
        self.createWidget('OWMDS', 'MDS.png', 'MDS', 1, self.signalManager)
        self.createWidget('OWHierarchicalClustering', 'HierarchicalClustering.png', 'Hierarchical Clustering', 1, self.signalManager)
        ...
        self.signalManager.addLink( self.widgets['Example Distance'], self.widgets['Distance Map'], 'Distance Matrix', 'Distance Matrix', 1)
        self.signalManager.addLink( self.widgets['Attribute Distance'], self.widgets['Distance Map (2)'], 'Distance Matrix', 'Distance Matrix', 1)
        self.signalManager.addLink( self.widgets['Example Distance'], self.widgets['MDS'], 'Distance Matrix', 'Distances', 1)
        self.signalManager.addLink( self.widgets['Example Distance'], self.widgets['Hierarchical Clustering'], 'Distance Matrix', 'Distance matrix', 1)
        self.signalManager.addLink( self.widgets['Data Sampler'], self.widgets['Example Distance'], 'Sample', 'Examples', 1)
        self.signalManager.addLink( self.widgets['Data Sampler'], self.widgets['Attribute Distance'], 'Remaining Examples', 'Examples', 1)
        self.signalManager.addLink( self.widgets['Data Sampler'], self.widgets['Association Rules'], 'Sample', 'Examples', 1)
        self.signalManager.addLink( self.widgets['Data Sampler'], self.widgets['K-Means Clustering'], 'Sample', 'Examples', 1)
        self.signalManager.addLink( self.widgets['Data Sampler'], self.widgets['Interaction Graph'], 'Sample', 'Examples', 1)
