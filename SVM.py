...
class GUIApplication(OWBaseWidget):
    def __init__(self,parent=None):
        ...
        OWBaseWidget.__init__(self, title = 'SVM', signalManager = self.signalManager)
        self.widgets = {}
        self.loadSettings()
        ...
        self.signalManager.addLink( self.widgets['File'], self.widgets['SVM'], 'Examples', 'Example Table', 1)
        self.signalManager.addLink( self.widgets['SVM'], self.widgets['Data Table'], 'Support Vectors', 'Examples', 1)
        self.signalManager.addLink( self.widgets['File'], self.widgets['Scatterplot'], 'Examples', 'Examples', 1)
        self.signalManager.addLink( self.widgets['SVM'], self.widgets['Scatterplot'], 'Support Vectors', 'Example Subset', 1)
