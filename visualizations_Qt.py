...
class GUIApplication(OWBaseWidget):
    def __init__(self,parent=None):
        ...
        OWBaseWidget.__init__(self, title = 'visualizations_Qt', signalManager = self.signalManager)
        self.widgets = {}
        self.loadSettings()
        ...
        self.createWidget('OWLinProjQt', 'icons/LinearProjection.png', 'Linear Projection (Qt)', 1, self.signalManager)
        self.createWidget('OWParallelCoordinatesQt', 'icons/ParallelCoordinates.png', 'Parallel Coordinates (Qt)', 1, self.signalManager)
        self.createWidget('OWPolyvizQt', 'icons/Polyviz.png', 'Polyviz (Qt)', 1, self.signalManager)
        self.createWidget('OWRadvizQt', 'icons/Radviz.png', 'Radviz (Qt)', 1, self.signalManager)
        self.createWidget('OWScatterPlotQt', 'icons/ScatterPlot.png', 'Scatterplot (Qt)', 1, self.signalManager)
        ...
        self.signalManager.addLink( self.widgets['Select Attributes'], self.widgets['Scatterplot (Qt)'], 'Examples', 'Examples', 1)
        self.signalManager.addLink( self.widgets['Select Attributes'], self.widgets['Linear Projection (Qt)'], 'Examples', 'Examples', 1)
        self.signalManager.addLink( self.widgets['Select Attributes'], self.widgets['Radviz (Qt)'], 'Examples', 'Examples', 1)
        self.signalManager.addLink( self.widgets['Select Attributes'], self.widgets['Polyviz (Qt)'], 'Examples', 'Examples', 1)
        self.signalManager.addLink( self.widgets['Select Attributes'], self.widgets['Parallel Coordinates (Qt)'], 'Examples', 'Examples', 1)
        self.signalManager.addLink( self.widgets['File'], self.widgets['Data Sampler'], 'Examples', 'Data', 1)
        self.signalManager.addLink( self.widgets['Data Sampler'], self.widgets['Scatterplot (Qt)'], 'Sample', 'Example Subset', 1)
        self.signalManager.addLink( self.widgets['Data Sampler'], self.widgets['Linear Projection (Qt)'], 'Sample', 'Example Subset', 1)
        self.signalManager.addLink( self.widgets['Data Sampler'], self.widgets['Radviz (Qt)'], 'Sample', 'Example Subset', 1)
        self.signalManager.addLink( self.widgets['Data Sampler'], self.widgets['Polyviz (Qt)'], 'Sample', 'Example Subset', 1)
        self.signalManager.addLink( self.widgets['Data Sampler'], self.widgets['Parallel Coordinates (Qt)'], 'Sample', 'Example Subset', 1)
    ...
    def loadSettings(self):
        try:
            file = open("visualizations_Qt.sav", "r")
    ...
    def closeEvent(self, ev):
        ...
        for (name, widget) in self.widgets.items():
            ...
            widget.close()
        file = open("visualizations_Qt.sav", "w")
