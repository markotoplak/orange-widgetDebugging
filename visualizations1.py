...
class GUIApplication(OWBaseWidget):
    def __init__(self,parent=None):
        ...
        self.signalManager.addLink( self.widgets['Data Sampler'], self.widgets['Linear Projection'], 'Sample', 'Examples', 1)
    ...
    def loadSettings(self):
        try:
            file = open("visualizations1.sav", "r")
    ...
    def closeEvent(self, ev):
        ...
        for (name, widget) in self.widgets.items():
            ...
            widget.close()
        file = open("visualizations1.sav", "w")
