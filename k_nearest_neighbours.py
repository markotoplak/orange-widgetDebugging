...
class GUIApplication(OWBaseWidget):
    def __init__(self,parent=None):
        ...
        OWBaseWidget.__init__(self, title = 'k_nearest_neighbours', signalManager = self.signalManager)
        self.widgets = {}
        self.loadSettings()
    ...
    def loadSettings(self):
        try:
            file = open("k_nearest_neighbours.sav", "r")
    ...
    def closeEvent(self, ev):
        ...
        for (name, widget) in self.widgets.items():
            ...
            widget.close()
        file = open("k_nearest_neighbours.sav", "w")
