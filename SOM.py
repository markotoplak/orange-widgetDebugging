...
class GUIApplication(OWBaseWidget):
    def __init__(self,parent=None):
        ...
        OWBaseWidget.__init__(self, title = 'SOM', signalManager = self.signalManager)
        self.widgets = {}
        self.loadSettings()
        ...
        self.createWidget('OWSOM', 'icons/SOM.png', 'SOM', 1, self.signalManager)
        self.createWidget('OWSOMVisualizer', 'icons/SOMVisualizer.png', 'SOMVisualizer', 1, self.signalManager)
        ...
        self.signalManager.addLink( self.widgets['File'], self.widgets['SOM'], 'Examples', 'Examples', 1)
        self.signalManager.addLink( self.widgets['SOM'], self.widgets['SOMVisualizer'], 'SOMMap', 'SOMMap', 1)
