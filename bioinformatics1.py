...
# useonly: brown-selected.tab, brown-selected-noclass.tab
...
class GUIApplication(OWBaseWidget):
    def __init__(self,parent=None):
        ...
        OWBaseWidget.__init__(self, title = 'bioinformatics1', signalManager = self.signalManager)
        self.widgets = {}
        self.loadSettings()
        ...
        self.createWidget('OWFunctionalAnnotation', 'icons/Unknown.png', 'Gene Functional Annotation', 1, self.signalManager)
        self.createWidget('OWGeneInfo', 'icons/GeneInfo.png', 'Gene Info', 1, self.signalManager)
        self.createWidget('OWGsea', 'icons/GSEA.png', 'GSEA', 1, self.signalManager)
        ...
        self.signalManager.addLink( self.widgets['File'], self.widgets['Gene Functional Annotation'], 'Examples', 'Example Table', 1)
        self.signalManager.addLink( self.widgets['File'], self.widgets['Gene Info'], 'Examples', 'Examples', 1)
        self.signalManager.addLink( self.widgets['File'], self.widgets['GSEA'], 'Examples', 'Examples', 1)
    ...
    def loadSettings(self):
        try:
            file = open("bioinformatics1.sav", "r")
    ...
    def closeEvent(self, ev):
        ...
        for (name, widget) in self.widgets.items():
            ...
            widget.close()
        file = open("bioinformatics1.sav", "w")
