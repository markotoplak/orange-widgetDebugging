...
class GUIApplication(OWBaseWidget):
    def __init__(self,parent=None):
        ...
        self.createWidget('OWClassificationTreeViewer', 'icons/ClassificationTreeViewer.png', 'Classification Tree Viewer', 1, self.signalManager)
        self.createWidget('OWClassificationTreeGraph', 'icons/ClassificationTreeGraph.png', 'Classification Tree Graph', 1, self.signalManager)
        ...
        self.signalManager.addLink( self.widgets['Classification Tree'], self.widgets['Classification Tree Viewer'], 'Classification Tree', 'Classification Tree', 1)
        self.signalManager.addLink( self.widgets['C4.5'], self.widgets['Classification Tree Graph'], 'Classification Tree', 'Classification Tree', 1)
        self.signalManager.addLink( self.widgets['Data Sampler'], self.widgets['k Nearest Neighbours'], 'Sample', 'Examples', 1)
        self.signalManager.addLink( self.widgets['Data Sampler'], self.widgets['Interactive Tree Builder'], 'Sample', 'Examples', 1)
        self.signalManager.addLink( self.widgets['Data Sampler'], self.widgets['C4.5'], 'Sample', 'Examples', 1)
