...
class GUIApplication(OWBaseWidget):
    def __init__(self,parent=None):
        ...
        OWBaseWidget.__init__(self, title = 'associate1', signalManager = self.signalManager)
        self.widgets = {}
        self.loadSettings()
        ...
        self.createWidget('OWAssociationRules', 'icons/AssociationRules.png', 'Association Rules', 1, self.signalManager)
        self.createWidget('OWAssociationRulesViewer', 'icons/AssociationRulesViewer.png', 'Association Rules Filter', 1, self.signalManager)
        self.createWidget('OWAssociationRulesTreeViewer', 'icons/AssociationRulesTreeViewer.png', 'Association Rules Explorer', 1, self.signalManager)
        self.createWidget('OWItemsets', 'icons/Itemsets.png', 'Itemsets', 1, self.signalManager)
        self.createWidget('OWItemsetsExplorer', 'icons/ItemsetsExplorer.png', 'Itemsets Explorer', 1, self.signalManager)
        ...
        self.signalManager.addLink( self.widgets['File'], self.widgets['Association Rules'], 'Examples', 'Examples', 1)
        self.signalManager.addLink( self.widgets['Association Rules'], self.widgets['Association Rules Filter'], 'Association Rules', 'Association Rules', 1)
        self.signalManager.addLink( self.widgets['Association Rules'], self.widgets['Association Rules Explorer'], 'Association Rules', 'Association Rules', 1)
        self.signalManager.addLink( self.widgets['File'], self.widgets['Itemsets'], 'Examples', 'Examples', 1)
        self.signalManager.addLink( self.widgets['Itemsets'], self.widgets['Itemsets Explorer'], 'Itemsets', 'Itemsets', 1)
