...
class GUIApplication(OWBaseWidget):
    def __init__(self,parent=None):
        ...
        OWBaseWidget.__init__(self, title = 'rank', signalManager = self.signalManager)
        self.widgets = {}
        self.loadSettings()
        ...
        self.signalManager.addLink( self.widgets['Select Attributes'], self.widgets['Rank'], 'Examples', 'Examples', 1)
        self.signalManager.addLink( self.widgets['Rank'], self.widgets['Data Table'], 'Reduced Example Table', 'Examples', 1)
        self.signalManager.addLink( self.widgets['Rank'], self.widgets['Data Table'], 'ExampleTable Attributes', 'Examples', 1)
