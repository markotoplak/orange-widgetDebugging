...
class GUIApplication(OWBaseWidget):
    def __init__(self,parent=None):
        ...
        OWBaseWidget.__init__(self, title = 'visualizations2', signalManager = self.signalManager)
        self.widgets = {}
        self.loadSettings()
        ...
        self.createWidget('OWSieveMultigram', 'icons/SieveMultigram.png', 'Sieve multigram', 1, self.signalManager)
        ...
        self.signalManager.addLink( self.widgets['File'], self.widgets['Mosaic Display'], 'Examples', 'Examples', 1)
        self.signalManager.addLink( self.widgets['File'], self.widgets['Parallel Coordinates'], 'Examples', 'Examples', 1)
        self.signalManager.addLink( self.widgets['Data Sampler'], self.widgets['Mosaic Display'], 'Sample', 'Example Subset', 1)
        self.signalManager.addLink( self.widgets['Data Sampler'], self.widgets['Parallel Coordinates'], 'Sample', 'Example Subset', 1)
        self.signalManager.addLink( self.widgets['File'], self.widgets['Sieve multigram'], 'Examples', 'Examples', 1)
        self.signalManager.addLink( self.widgets['File'], self.widgets['Survey Plot'], 'Examples', 'Examples', 1)
    ...
    def loadSettings(self):
        try:
            file = open("visualizations2.sav", "r")
    ...
    def closeEvent(self, ev):
        ...
        for (name, widget) in self.widgets.items():
            ...
            widget.close()
        file = open("visualizations2.sav", "w")
