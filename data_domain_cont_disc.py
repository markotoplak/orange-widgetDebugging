...
class GUIApplication(OWBaseWidget):
    def __init__(self,parent=None):
        ...
        OWBaseWidget.__init__(self, title = 'data_domain_cont_disc', signalManager = self.signalManager)
        self.widgets = {}
        self.loadSettings()
        ...
        self.createWidget('OWExampleDistance', 'icons/ExampleDistance.png', 'Example Distance (2)', 1, self.signalManager)
        self.createWidget('OWAttributeDistance', 'icons/AttributeDistance.png', 'Attribute Distance (2)', 1, self.signalManager)
        self.createWidget('OWAttributeStatistics', 'icons/AttributeStatistics.png', 'Attribute Statistics (2)', 1, self.signalManager)
        ...
        self.signalManager.addLink( self.widgets['Discretize'], self.widgets['Attribute Distance'], 'Examples', 'Examples', 1)
        self.signalManager.addLink( self.widgets['Select Attributes'], self.widgets['Continuize'], 'Examples', 'Examples', 1)
        self.signalManager.addLink( self.widgets['Discretize'], self.widgets['Example Distance'], 'Examples', 'Examples', 1)
        self.signalManager.addLink( self.widgets['Continuize'], self.widgets['Example Distance (2)'], 'Examples', 'Examples', 1)
        self.signalManager.addLink( self.widgets['Continuize'], self.widgets['Attribute Distance (2)'], 'Examples', 'Examples', 1)
        self.signalManager.addLink( self.widgets['Continuize'], self.widgets['Attribute Statistics'], 'Examples', 'Examples', 1)
        self.signalManager.addLink( self.widgets['Discretize'], self.widgets['Attribute Statistics (2)'], 'Examples', 'Examples', 1)
    ...
    def loadSettings(self):
        try:
            file = open("data_domain_cont_disc.sav", "r")
    ...
    def closeEvent(self, ev):
        ...
        for (name, widget) in self.widgets.items():
            ...
            widget.close()
        file = open("data_domain_cont_disc.sav", "w")
