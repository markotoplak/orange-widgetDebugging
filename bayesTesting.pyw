...
class GUIApplication(OWBaseWidget):
    def __init__(self,parent=None):
        ...
        OWBaseWidget.__init__(self, title = 'bayesTesting', signalManager = self.signalManager)
        self.widgets = {}
        self.loadSettings()
        ...
        self.createWidget('OWFile', r'E:\Development\Orange-Qt4\OrangeWidgets\icons/File.png', 'File', 1, self.signalManager)
        self.createWidget('OWNaiveBayes', r'E:\Development\Orange-Qt4\OrangeWidgets\icons/NaiveBayes.png', 'Naive Bayes', 1, self.signalManager)
        self.createWidget('OWTestLearners', r'E:\Development\Orange-Qt4\OrangeWidgets\icons/TestLearners.png', 'Test Learners', 1, self.signalManager)
