...
class GUIApplication(OWBaseWidget):
    def __init__(self,parent=None):
        ...
        OWBaseWidget.__init__(self, title = 'vulcano_plot', signalManager = self.signalManager)
        self.widgets = {}
        self.loadSettings()
        ...
        self.signalManager.addLink( self.widgets['Data Sampler'], self.widgets['Vulcano Plot'], 'Sample', 'Examples', 1)
