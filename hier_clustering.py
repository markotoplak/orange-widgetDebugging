...
#ignore:breastcancer2004.tab,titanic.tab
...
class GUIApplication(OWBaseWidget):
    def __init__(self,parent=None):
        ...
        OWBaseWidget.__init__(self, title = 'hier_clustering', signalManager = self.signalManager)
        self.widgets = {}
        self.loadSettings()
        ...
        self.createWidget('OWHierarchicalClustering', 'icons/HierarchicalClustering.png', 'Hierarchical Clustering', 1, self.signalManager)
        self.createWidget('OWHierarchicalClustering', 'icons/HierarchicalClustering.png', 'Hierarchical Clustering (2)', 1, self.signalManager)
        ...
        self.signalManager.addLink( self.widgets['File'], self.widgets['Attribute Distance'], 'Examples', 'Examples', 1)
        self.signalManager.addLink( self.widgets['Hierarchical Clustering'], self.widgets['Data Table'], 'Selected Examples', 'Examples', 1)
        self.signalManager.addLink( self.widgets['Hierarchical Clustering (2)'], self.widgets['Data Table'], 'Selected Examples', 'Examples', 1)
        ...
        self.signalManager.addLink( self.widgets['Attribute Distance'], self.widgets['Hierarchical Clustering (2)'], 'Distance Matrix', 'Distance matrix', 1)
    ...
    def loadSettings(self):
        try:
            file = open("hier_clustering.sav", "r")
    ...
    def closeEvent(self, ev):
        ...
        for (name, widget) in self.widgets.items():
            ...
            widget.close()
        file = open("hier_clustering.sav", "w")
